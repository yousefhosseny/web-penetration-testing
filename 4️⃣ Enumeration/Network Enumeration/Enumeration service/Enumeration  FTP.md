## 📌 **شرح عميق وبسيط لـ FTP Enumeration + Web Pentesting Steps**

هناخد **FTP Enumeration بالتفصيل بس بأبسط طريقة**، وبعد كل جزء **الخلاصة بالعامية المصرية**، وفي الآخر **خطوات عملية لاختبار اختراق الويب.**
...
📌 FTP (File Transfer Protocol) هو بروتوكول بيستخدم لنقل الملفات بين الأجهزة على الشبكة. لما بنعمل **FTP Enumeration**، بنحاول نجمع معلومات عن السيرفر عشان نعرف إذا كان فيه ثغرات نقدر نستغلها.
